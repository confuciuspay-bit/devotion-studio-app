    ...
    <div className="rounded-3xl border border-border bg-foreground/5 p-5">
      <div className="flex items-baseline justify-center gap-2">
        ...
        <input
          ...
          placeholder="0"
          className="bg-transparent outline-none w-1/2 text-center text-5xl font-display font-semibold tabular-nums placeholder:text-muted-foreground/40"
        />
        <span className="text-3xl font-display font-semibold text-muted-foreground">
          {mode === "token" ? symbol : ""}
        </span>
      ...
      <div className="mt-4 flex items-center justify-between">
        ...
        {balance != null && (
          <div className="flex items-center gap-2 text-[11px] text-muted-foreground font-mono">
            ...
            <button onClick={setMax} className="px-2 py-0.5 rounded-full bg-primary/15 text-primary font-semibold">
              MAX
            </button>
          </div>
        )}
